# Reusable functions and calculations (`src/`)
...
Subfolders separate Operating Model functions, simulated observations, estimation/assessment, management procedures, implementation, performance metrics, validation, and file input/output.
